...
// Pano2VR 7.1.7/20981
// Filename: TESTE SETA STW.ggsk
// Generated 2025-02-15T20:40:42

function pano2vrSkin(player,base) {
	player.addVariable('opt_3d_preview', 2, true, { ignoreInState: 1  });
	player.addVariable('opt_3d_preview_1', 2, true, { ignoreInState: 1  });
	player.addVariable('opt_3d_preview_2', 2, true, { ignoreInState: 1  });
	player.addVariable('opt_3d_preview_3', 2, true, { ignoreInState: 1  });
	player.addVariable('opt_3d_preview_4', 2, true, { ignoreInState: 1  });
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		player.addListener('varchanged_opt_3d_preview_4', function(event) {
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
					hotspotTemplates['ht_node'][i].ggEvent_varchanged_opt_3d_preview_4();
				}
			}
		});
	};
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
			'';
		...
		hs+='cursor : pointer;';
		hs+='height : 83px;';
		hs+='left : calc(50% - ((80px + 0px) / 2) + 6px);';
		hs+='opacity : 0.6;';
		hs+='position : absolute;';
		hs+='top : -126px;';
		hs+='visibility : inherit;';
		...
		hs+='z-index: -5;';
		hs+='height : 93px;';
		hs+='left : calc(50% - ((140px + 0px) / 2) + 6px);';
		hs+='opacity : 0;';
		hs+='position : absolute;';
		hs+='top : -206px;';
		...
		me._hs_preview_image.logicBlock_alpha = function() {
			...
			if (
				((me.elementMouseOver['ht_node'] == true)) && 
				((player.getVariableValue('opt_3d_preview_4') == true)) && 
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		hs+='cursor : pointer;';
		hs+='height : 53px;';
		hs+='left : calc(50% - ((50px + 0px) / 2) + 6px);';
		hs+='position : absolute;';
		hs+='top : -126px;';
		hs+='visibility : inherit;';
		hs+='width : 50px;';
...
this.__div.style.top = vs.height / 2 + "px";
		...
		me._ht_node_customimage.logicBlock_visible();
			...
			me.ggEvent_varchanged_opt_3d_preview_4=function() {
				me._hs_preview_image.logicBlock_alpha();
				me._tt_ht_3d.logicBlock_visible();
			};
